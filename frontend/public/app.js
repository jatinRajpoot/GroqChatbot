// Ported client-side interactions from Flask template
...
// Ensure initialization runs whether or not DOMContentLoaded has already fired
...
function highlightModelSelector() {
  ...
  if (!hasSeenHighlight && welcomeScreen && welcomeScreen.style.display !== 'none') {
